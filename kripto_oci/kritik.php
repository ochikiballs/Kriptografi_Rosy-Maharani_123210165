  ...
  <html lang="en">
    ...
    <body>
        ...
        <center>
            ...
            <p>"Dalam melukis kritik dan memberikan saran pada Etheral Book, mari jadikan setiap kata seperti sapuan kuas halus yang memperkaya lukisan keindahan,
            </p>
            <p>sehingga toko ini dapat terus menjadi tempat yang mengundang, penuh pesona, dan penuh inspirasi bagi para pencinta buku."
            </p>
        </center>
