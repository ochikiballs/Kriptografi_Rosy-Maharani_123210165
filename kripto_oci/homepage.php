        ...
        <div class="mx-auto d-flex flex-lg-row flex-column hero">
          ...
          <div
            ...
            <h1 class="title-text-big">
              ...
              <span style="color: #4E91F9">Etheral Book</span>?<br class="d-lg-block d-none" />
              
            </h1>
            <p class="text-caption">
              "Ethereal Book" adalah toko buku yang memadukan keindahan estetika dengan pengalaman membaca yang mempesona. Suasana magis dan koleksi buku yang dipilih dengan cermat menciptakan tempat ideal bagi pencinta buku yang mencari petualangan literer yang unik.
            </p>
          ...
          <div class="right-column d-flex justify-content-center justify-content-lg-start text-center pe-0" >
            <img class="position-absolute d-lg-block d-none hero-right" style="width: 600px"
              src="assets/img/magicbook.png"
              alt="logo" />
